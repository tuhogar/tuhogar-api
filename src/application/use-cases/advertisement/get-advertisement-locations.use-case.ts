...
export class GetAdvertisementLocationsUseCase {
  ...
  async execute(
    getAdvertisementLocationsUseCaseCommand: GetAdvertisementLocationsUseCaseCommand,
  ): Promise<any> {
    return this.algoliaService.getLocations(
      getAdvertisementLocationsUseCaseCommand.query,
    );
  }
}

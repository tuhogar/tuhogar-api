...
export abstract class ISubscriptionRepository {
  ...
  abstract cancelOnPaymentGateway(id: string, effectiveCancellationDate: Date, status: SubscriptionStatus, newPlanId?: string): Promise<Subscription>;
  ...
  abstract findSubscriptionsToCancelAndDowngrade(currentDate: Date): Promise<Subscription[]>;

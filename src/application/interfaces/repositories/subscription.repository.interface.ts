...
export abstract class ISubscriptionRepository {
  ...
  abstract findOneActiveOrCreatedByAccountId(
    accountId: string,
  ...
  abstract updateExternalReferences(
    id: string,
    externalId: string,
    externalPayerReference: string,
  ...
  abstract findSubscriptionsToCancel(
    currentDate: Date,
  ): Promise<Subscription[]>;
  abstract findSubscriptionsToCancelAndDowngrade(
    currentDate: Date,
  ): Promise<Subscription[]>;
  abstract updatePaymentDate(
    id: string,
    paymentDate: Date,
  ): Promise<Subscription>;
  abstract updateNextPaymentDate(
    id: string,
    nextPaymentDate: Date,
  ): Promise<Subscription>;

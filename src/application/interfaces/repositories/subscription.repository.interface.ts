...
export abstract class ISubscriptionRepository {
  ...
  abstract updateExternalReferences(id: string, externalId: string, externalPayerReference: string, resultIntegration: Record<string, any>, status: SubscriptionStatus): Promise<Subscription>;

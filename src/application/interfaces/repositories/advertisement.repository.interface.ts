...
export abstract class IAdvertisementRepository {
    ...
    abstract findByAccountIdWithEvents(accountId: string, page: number, limit: number, code: number, transactionType: AdvertisementTransactionType, type: AdvertisementType, externalId: string, status: AdvertisementStatus): Promise<{ data: Advertisement[]; count: number }>
    abstract findAllWithEvents(page: number, limit: number, code: number, transactionType: AdvertisementTransactionType, type: AdvertisementType, externalId: string, status: AdvertisementStatus): Promise<{ data: Advertisement[]; count: number }>
    ...
    abstract findByIds(ids: string[]): Promise<Advertisement[]>

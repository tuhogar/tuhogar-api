...
export abstract class IAdvertisementRepository {
  ...
  abstract findByAccountIdWithEvents(
    accountId: string,
    page: number,
    limit: number,
    code: number,
  ...
  abstract findActiveOrWaitingWithExcessPhotos(
    accountId: string,
    maxPhotos: number,
  ): Promise<Advertisement[]>;
  abstract findActiveOrWaitingByAccountIdWithOrder(
    accountId: string,
    orderBy: string,

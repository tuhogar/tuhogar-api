...
export abstract class IAdvertisementRepository {
    ...
    abstract findByAccountIdWithEvents(accountId: string, page: number, limit: number, transactionType: AdvertisementTransactionType, type: AdvertisementType, externalId: string): Promise<{ data: Advertisement[]; count: number }>

...
export class AlgoliaService {
  ...
  async bulk(advertisements: Advertisement[]): Promise<void> {
    await Promise.all(
      advertisements.map(async (a: any) => {
        a.objectID = a._id;
  ...
  async get(
    ...
    if (getActivesAdvertisementDto.code) {
      ...
      addMultiValueFilter(
        'transactionType',
        getActivesAdvertisementDto.transactionType,
        'OR',
      );
      addMultiValueFilter('type', getActivesAdvertisementDto.type, 'OR');
      addMultiValueFilter(
        'constructionType',
        getActivesAdvertisementDto.constructionType,
        'OR',
      );

      if (getActivesAdvertisementDto.accountId !== undefined)
        filters.push(`accountId:${getActivesAdvertisementDto.accountId}`);
      if (getActivesAdvertisementDto.allContentsIncluded !== undefined)
        filters.push(
          `allContentsIncluded:${getActivesAdvertisementDto.allContentsIncluded}`,
        );
      if (getActivesAdvertisementDto.isResidentialComplex !== undefined)
        filters.push(
          `isResidentialComplex:${getActivesAdvertisementDto.isResidentialComplex}`,
        );
      if (getActivesAdvertisementDto.isPenthouse !== undefined)
        filters.push(`isPenthouse:${getActivesAdvertisementDto.isPenthouse}`);
      if (getActivesAdvertisementDto.isHoaIncluded !== undefined)
        filters.push(
          `isHoaIncluded:${getActivesAdvertisementDto.isHoaIncluded}`,
        );

      addMultiValueFilter(
        'amenities',
        getActivesAdvertisementDto.amenity,
        'AND',
      );
      addMultiValueFilter(
        'communityAmenities',
        getActivesAdvertisementDto.communityAmenity,
        'AND',
      );
      addMultiValueFilter(
        'contractTypes',
        getActivesAdvertisementDto.contractType,
        'AND',
      );

      addRangeFilter(
        'bedsCount',
        getActivesAdvertisementDto.bedsCountMin,
        getActivesAdvertisementDto.bedsCountMax,
      );
      addRangeFilter(
        'bathsCount',
        getActivesAdvertisementDto.bathsCountMin,
        getActivesAdvertisementDto.bathsCountMax,
      );
      addRangeFilter(
        'parkingCount',
        getActivesAdvertisementDto.parkingCountMin,
        getActivesAdvertisementDto.parkingCountMax,
      );
      addRangeFilter(
        'floorsCount',
        getActivesAdvertisementDto.floorsCountMin,
        getActivesAdvertisementDto.floorsCountMax,
      );
      addRangeFilter(
        'floorNumber',
        getActivesAdvertisementDto.floorNumberMin,
        getActivesAdvertisementDto.floorNumberMax,
      );
      addRangeFilter(
        'constructionYear',
        getActivesAdvertisementDto.constructionYearMin,
        getActivesAdvertisementDto.constructionYearMax,
      );
      addRangeFilter(
        'socioEconomicLevel',
        getActivesAdvertisementDto.socioEconomicLevelMin,
        getActivesAdvertisementDto.socioEconomicLevelMax,
      );
      addRangeFilter(
        'hoaFee',
        getActivesAdvertisementDto.hoaFeeMin,
        getActivesAdvertisementDto.hoaFeeMax,
      );
      addRangeFilter(
        'lotArea',
        getActivesAdvertisementDto.lotAreaMin,
        getActivesAdvertisementDto.lotAreaMax,
      );
      addRangeFilter(
        'floorArea',
        getActivesAdvertisementDto.floorAreaMin,
        getActivesAdvertisementDto.floorAreaMax,
      );
      addRangeFilter(
        'price',
        getActivesAdvertisementDto.priceMin,
        getActivesAdvertisementDto.priceMax,
      );
      addRangeFilter(
        'pricePerLotArea',
        getActivesAdvertisementDto.pricePerLotAreaMin,
        getActivesAdvertisementDto.pricePerLotAreaMax,
      );
      addRangeFilter(
        'pricePerFloorArea',
        getActivesAdvertisementDto.pricePerFloorAreaMin,
        getActivesAdvertisementDto.pricePerFloorAreaMax,
      );
      addRangeFilter(
        'propertyTax',
        getActivesAdvertisementDto.propertyTaxMin,
        getActivesAdvertisementDto.propertyTaxMax,
      );
    }
    ...
    addSearchText(
      'neighbourhoodSlug',
      getActivesAdvertisementDto.neighbourhoodSlug,
    );
    ...
    const options: any = {
      ...
      restrictSearchableAttributes:
        restrictSearchableAttributes.length > 0
          ? restrictSearchableAttributes
          : undefined,
    ...
    if (
      getActivesAdvertisementDto.latitude &&
      getActivesAdvertisementDto.longitude &&
      getActivesAdvertisementDto.radius
    ) {
    ...
    if (getActivesAdvertisementDto.page)
      options['page'] = getActivesAdvertisementDto.page - 1;
    if (getActivesAdvertisementDto.limit)
      options['hitsPerPage'] = getActivesAdvertisementDto.limit;
    ...
    if (getActivesAdvertisementDto.orderBy) {
      switch (getActivesAdvertisementDto.orderBy) {
        case AdvertisementActivesOrderBy.LOWEST_PRICE:
          selectedIndex = this.client.initIndex(
            `${this.indexName}${AlgoliaIndexes.ADVERTISEMENTS_PRICE_ASC}`,
          );
          break;
        case AdvertisementActivesOrderBy.HIGHEST_PRICE:
          selectedIndex = this.client.initIndex(
            `${this.indexName}${AlgoliaIndexes.ADVERTISEMENTS_PRICE_DESC}`,
          );
          break;
        case AdvertisementActivesOrderBy.LOWEST_PRICE_M2:
          selectedIndex = this.client.initIndex(
            `${this.indexName}${AlgoliaIndexes.ADVERTISEMENTS_PRICE_PER_FLOOR_AREA_ASC}`,
          );
          break;
        case AdvertisementActivesOrderBy.HIGHEST_PRICE_M2:
          selectedIndex = this.client.initIndex(
            `${this.indexName}${AlgoliaIndexes.ADVERTISEMENTS_PRICE_PER_FLOOR_AREA_DESC}`,
          );
          break;
        default:
          selectedIndex = this.client.initIndex(
            `${this.indexName}${AlgoliaIndexes.ADVERTISEMENTS_UPDATED_AT_DESC}`,
          );
          break;
      }
    } else {
  ...
  async getLocations(query: string): Promise<any> {
    ...
    hits.forEach((hit: any) => {
      ...
      const normalizedNeighbourhood = neighbourhood
        ? this.normalizeString(neighbourhood)
        : '';
      const normalizedEstablishment = establishment
        ? this.normalizeString(establishment)
        : '';

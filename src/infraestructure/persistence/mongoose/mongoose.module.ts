...
} from './entities/bulk-update-date.entity';
import {
  AdvertisementReport,
  AdvertisementReportSchema,
} from './entities/advertisement-report.entity';
import {
  AdvertisementReason,
  AdvertisementReasonSchema,
} from './entities/advertisement-reason.entity';
import {
  AdvertisementCode,
  AdvertisementCodeSchema,
} from './entities/advertisement-code.entity';
...
} from './entities/subscription-notification.entity';
...
} from './entities/advertisement-event.entity';
import {
  AccountAdvertisementStatistics,
  AccountAdvertisementStatisticsSchema,
} from './entities/account-advertisement-statistics.entity';
...
} from './entities/advertisement-statistics.entity';
...
import {
  AccountCoupon,
  AccountCouponSchema,
} from './entities/account-coupon.entity';
...
import {
  AccountEvent,
  AccountEventSchema,
} from './entities/account-event.entity';
...
import {
  BlacklistWord,
  BlacklistWordSchema,
} from './entities/blacklist-word.entity';
@Module({
  imports: [
    ...
    MongooseModuleLib.forFeature([
      ...
      {
        name: SubscriptionNotification.name,
        schema: SubscriptionNotificationSchema,
      },
      {
        name: AccountAdvertisementStatistics.name,
        schema: AccountAdvertisementStatisticsSchema,
      },
      {
        name: AdvertisementStatistics.name,
        schema: AdvertisementStatisticsSchema,
      },

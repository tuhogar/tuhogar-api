...
export class MongooseAccountMapper {
  static toDomain(entity: AccountDocument): Account {
    ...
    if (!!entity.subscriptions) {
      subscriptions = entity.subscriptions.map((a) =>
        MongooseSubscriptionMapper.toDomain(a),
      );
    ...
    const model = new Account({
      ...
      socialMedia: !!entity.socialMedia
        ? MongooseSocialMediaMapper.toDomain(entity.socialMedia)
        : undefined,
      description: entity.description,
      documentType: entity.documentType as AccountDocumentType,
      documentNumber: entity.documentNumber,
      contractTypes: !!entity.contractTypes
        ? entity.contractTypes.map((a) =>
            MongooseContractTypeMapper.toDomain(a),
          )
        : undefined,
      subscription,
      subscriptions,

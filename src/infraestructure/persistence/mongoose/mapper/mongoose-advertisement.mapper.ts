...
export class MongooseAdvertisementMapper {
  static toDomain(entity: AdvertisementDocument): Advertisement {
    ...
    if (!!entity.advertisementEvents) {
      advertisementEvents = entity.advertisementEvents.map((a) =>
        MongooseAdvertisementEventMapper.toDomain(a),
      );
    }
    ...
    const model = new Advertisement({
      ...
      constructionType:
        entity.constructionType as AdvertisementConstructionType,
      ...
      amenities: !!entity.amenities
        ? entity.amenities.map((a) => MongooseAmenityMapper.toDomain(a))
        : undefined,
      communityAmenities: !!entity.communityAmenities
        ? entity.communityAmenities.map((a) =>
            MongooseAmenityMapper.toDomain(a),
          )
        : undefined,
      ...
      address: !!entity.address
        ? MongooseAddressMapper.toDomain(entity.address)
        : undefined,
  ...
  static toMongoose(advertisement: Advertisement) {
    return {
      ...
      floorNumber: advertisement.floorNumber,

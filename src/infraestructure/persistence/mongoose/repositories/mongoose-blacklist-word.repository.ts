...
export class MongooseBlacklistWordRepository
  implements IBlacklistWordRepository
{
  constructor(
    @InjectModel(BlacklistWordMongoose.name)
    private readonly blacklistWordModel: Model<BlacklistWordMongoose>,
  ) {}

...
export class MongooseAccountAdvertisementStatisticsRepository
  implements IAccountAdvertisementStatisticsRepository
{
  constructor(
  ...
  async create(
    statistics: AccountAdvertisementStatistics,
  ): Promise<AccountAdvertisementStatistics> {
    const data =
      MongooseAccountAdvertisementStatisticsMapper.toMongoose(statistics);
  ...
  async update(
    id: string,
    statistics: Partial<AccountAdvertisementStatistics>,
  ): Promise<AccountAdvertisementStatistics> {
    const data = MongooseAccountAdvertisementStatisticsMapper.toMongoose(
      statistics as AccountAdvertisementStatistics,
    );
  ...
  async findLastAccumulatedByAccountId(
    accountId: string,
  ): Promise<AccountAdvertisementStatistics> {
    const query = await this.accountAdvertisementStatisticsModel

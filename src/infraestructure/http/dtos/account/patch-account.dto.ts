...
export class PatchAccountDto {
  ...
  @MaxLength(150, {
    message: 'invalid.name.must.be.shorter.than.or.equal.to.150.characters',
  })
  @Property()
  name: string;
  ...
  @MaxLength(30, {
    message: 'invalid.phone.must.be.shorter.than.or.equal.to.30.characters',
  })
  @Property()
  phone: string;
  ...
  @MaxLength(30, {
    message: 'invalid.whatsApp.must.be.shorter.than.or.equal.to.30.characters',
  })
  @Property()
  whatsApp: string;
  ...
  @MaxLength(30, {
    message: 'invalid.phone2.must.be.shorter.than.or.equal.to.30.characters',
  })
  @Property()
  phone2: string;
  ...
  @MaxLength(30, {
    message: 'invalid.whatsApp2.must.be.shorter.than.or.equal.to.30.characters',
  })
  @Property()
  whatsApp2: string;
  ...
  @MaxLength(150, {
    message: 'invalid.webSite.must.be.shorter.than.or.equal.to.150.characters',
  })
  @Property()
  webSite: string;
  ...
  @MaxLength(1000, {
    message:
      'invalid.description.must.be.shorter.than.or.equal.to.1000.characters',
  })
  @Property()
  description: string;
  ...
  @ApiPropertyOptional()
  @IsOptional()
  @IsEnum(AccountDocumentType, {
    message:
      'invalid.documentType.must.be.one.of.the.following.values.CC.CE.NIT',
  })
  @Property()
  ...
  @MaxLength(30, {
    message:
      'invalid.documentNumber.must.be.shorter.than.or.equal.to.30.characters',
  })
  @Property()
  ...
  @ContractTypeIsExistingId({
    each: true,
    message: 'each.contractType.id.must.exist',
  })
  @Property()
  ...
  @IsEnum(AccountType, {
    message:
      'invalid.accountType.must.be.one.of.the.following.values.BUYER.SELLER',
  })
  @Property()
  ...
  @MaxLength(100, {
    message: 'invalid.domain.must.be.shorter.than.or.equal.to.100.characters',
  })
  @Matches(/^[a-zA-Z0-9]+$/, {
    message: 'invalid.domain.must.contain.only.letters.and.numbers',
  })
  @Transform(({ value }) =>
    value ? value.toLowerCase().replace(/[^a-z0-9]/gi, '') : value,
  )

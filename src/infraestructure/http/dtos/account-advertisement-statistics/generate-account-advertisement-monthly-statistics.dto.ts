...
export class GenerateAccountAdvertisementMonthlyStatisticsDto {
  @ApiPropertyOptional({
    description:
      'Mês para o qual as estatísticas serão geradas (formato: YYYY-MM)',
    example: '2025-04',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'ID da conta para a qual as estatísticas serão geradas. Se não fornecido, gera para todas as contas ativas.',

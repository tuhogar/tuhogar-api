...
export class CreateUpdateAdvertisementDto {
  ...
  @IsEnum(AdvertisementTransactionType, {
    message:
      'invalid.transactionType.must.be.one.of.the.following.values.RENT.SALE',
  })
  @Property()
  ...
  @IsEnum(AdvertisementType, {
    message:
      'invalid.type.must.be.one.of.the.following.values.APARTMENT.HOUSE.BUILDING.LOT.WAREHOUSE.OFFICE.COMMERCIAL',
  })
  @Property()
  type: AdvertisementType;

  @ApiProperty()
  @IsEnum(AdvertisementConstructionType, {
    message:
      'invalid.constructionType.must.be.one.of.the.following.values.UNDER_CONSTRUCTION.READY_TO_MOVE',
  })
  @Property()
  ...
  @ApiProperty()
  @Transform(({ obj }) =>
    obj.type !== AdvertisementType.HOUSE &&
    obj.type !== AdvertisementType.APARTMENT &&
    obj.type !== AdvertisementType.LOT
      ? false
      : obj.isResidentialComplex,
  )
  @IsBoolean({
  ...
  @ApiProperty()
  @Transform(({ obj }) =>
    obj.type !== AdvertisementType.APARTMENT ? false : obj.isPenthouse,
  )
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.bedsCount.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @IsOptional()
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.bathsCount.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @IsOptional()
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.parkingCount.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.floorsCount.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @IsOptional()
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.floorNumber.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @IsOptional()
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.constructionYear.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.socioEconomicLevel.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @Property()
  ...
  @AmenityIsExistingId({
    each: true,
    message: 'each.communityAmenities.id.must.exist',
  })
  @IsOptional()
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.hoaFee.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @Property()
  hoaFee: number = 0;
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.lotArea.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @Property()
  lotArea: number = 0;
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.floorArea.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @Property()
  floorArea: number = 0;
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.propertyTax.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  @IsOptional()
  @Property()
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.pricePerFloorArea.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )
  ...
  @IsNumber(
    ...
    {
      message:
        'invalid.pricePerLotArea.must.be.a.number.conforming.to.the.specified.constraints',
    },
  )

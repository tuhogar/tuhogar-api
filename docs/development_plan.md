...
- [x] 7.4.1. Atualizar testes unitários para ReceiveSubscriptionPaymentNotificationUseCase (1h)
...
### 12.2. Atualização do Repositório
...
## 14. Renomeação da propriedade `duration` para `freeTrialDays` no domínio Plan
